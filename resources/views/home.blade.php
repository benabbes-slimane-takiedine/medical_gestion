          ...
          <div class="col-md-12">
            ...
            <div class="collapse navbar-collapse navbar-right" id="myNavbar">
              <ul class="nav navbar-nav">
                ...
                <li class="active nav-item"><a href="#banner">Home</a></li>
                <li class="nav-item"><a href="#service">Services</a></li>
                <li class="nav-item"><a href="#about">About</a></li>
                <li class="nav-item"><a href="{{url('patient')}}">Patient</a></li>
                 @if(auth()->user()->job=="Agent d'acceuil")
                  <li class="nav-item"><a href="{{url('Aum')}}">Message </a></li>
                  @endif
